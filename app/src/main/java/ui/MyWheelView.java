...
import utils.DP2Tools;

/**
 * Created by xinqi on 2016/1/11
 */
public class MyWheelView extends ScrollView {
	...
	private TextView createView(String item) {
		...
		int padding = DP2Tools.dip2px(context, 10);
	...
	public void setBackgroundDrawable(Drawable background) {
		...
		if (null == paint) {
			...
			paint.setStrokeWidth(DP2Tools.dip2px(context, 1f));
		}
	...
	private void onSeletedCallBack() {
		if (null != onWheelSelectListener) {
			onWheelSelectListener.onSelected(selectedIndex, items.get(selectedIndex));
		}
	...
	public OnWheelSelectListener getOnWheelViewListener() {
		return onWheelSelectListener;
	}

	public void setOnWheelViewListener(OnWheelSelectListener onWheelViewListener) {
		this.onWheelSelectListener = onWheelViewListener;
	}
